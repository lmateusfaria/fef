...
<form name="cadastrarautor" action="AutorCadastrar" method="POST">
    <table align="center" border="0">
        <thead>
            <tr>
                <th colspan="2" align="center">Cadastro de Autor</th>
            </tr>
            <tr>
        ...
        <tbody>
            <tr>
                <td>ID: </td>
                <td><input type="text" name="id_autor" id="id_autor" value="${autor.idAutor}" readonly></td>
            </tr>
            <tr>
                <td>NOME: </td>
                <td><input type="text" name="nome" id="nome" value="${autor.nomeAutor}"></td>
            </tr>
