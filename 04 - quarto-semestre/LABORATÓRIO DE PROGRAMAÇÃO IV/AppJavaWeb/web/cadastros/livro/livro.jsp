...
<table id="datatable" class="display">
    <thead>
        <tr>
            ...
            <th align="left">Nº Páginas</th>
            <th align="left">Tipo de Capa</th>
    ...
    <tbody>
        <c:forEach var="livro" items="${livros}">
            <tr>
                ...
                <td align="left">${livro.numeroPaginas}</td>
                ...
                <td align="center">
                    <a href="${pageContext.request.contextPath}/LivroExcluir?idLivro=${livro.idLivro}">Excluir</a>
                </td>
                <td align="center">
                    <a href="${pageContext.request.contextPath}/LivroCarregar?idLivro=${livro.idLivro}">Alterar</a>
                </td>
