...
<form name="cadastrareditora" action="EditoraCadastrar" method="POST">
    <table align="center" border="0">
        ...
        <tbody>
            <tr>
                <td>ID: </td>
                <td><input type="text" name="id_editora" id="id_editora" value="${editora.idEditora}" readonly></td>
            </tr>
            <tr>
                <td>NOME: </td>
                <td><input type="text" name="nome_editora" id="nome_editora" value="${editora.nomeEditora}"></td>
            </tr>
