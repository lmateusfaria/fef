    ...
    <tbody>
        <c:forEach var="autor" items="${autores}">
            <tr>
                ...
                <td align="center">
                    <a href="${pageContext.request.contextPath}/AutorExcluir?idAutor=${autor.idAutor}">Excluir</a>
                </td>
                <td align="center">
                    <a href="${pageContext.request.contextPath}/AutorCarregar?idAutor=${autor.idAutor}">Alterar</a>
                </td>
